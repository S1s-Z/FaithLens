...
from minicheck.inference import Inferencer, LLMCheck, LLMCheckHF
from typing import List
import numpy as np


class MiniCheck:
    def __init__(self, model_name='Bespoke-MiniCheck-7B', max_model_len=None, batch_size=16, cache_dir=None, tensor_parallel_size=1, max_tokens=1, do_vllm=True, enable_prefix_caching=False) -> None:
    ...
    def score(self, docs: List[str], claims: List[str], chunk_size=None) -> List[float]:
        ...
        elif isinstance(self.model, LLMCheckHF):
            return self._score_llmcheck(docs, claims, chunk_size)
