...
Experiments across 12 diverse benchmarks show that FaithLens outperforms advanced LLMs (e.g., GPT-5.2, o3) while maintaining significantly lower inference cost.
